        ...
        <form class="layui-form layui-form-pane" lay-filter="add"  method="post" action="{{url('admin/buses')}}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="buses_yingyun_type" lay-verify="required" placeholder="请输入营运类型" autocomplete="off" class="layui-input">
                    </div>
                </div>
                {{--车型--}}
                <div class="layui-inline">
            ...
            <div  class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="buses_sit" lay-verify="required|cate_view" placeholder="请输入核载人数" autocomplete="off" class="layui-input" >
                    </div>
                </div>
                {{--保险期限--}}
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="buses_insurance_date" lay-verify=""  placeholder="请输入保险期限" autocomplete="off" class="layui-input">
                    </div>
                </div>
                {{--保险期限--}}
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="buses_approve_date" lay-verify=""  placeholder="请输入车辆审验时间" autocomplete="off" class="layui-input" >
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="buses_start_date" lay-verify="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">返回时间</label>
                    <div class="layui-input-inline">
                        <input type="text" name="buses_end_date" lay-verify="" autocomplete="off" class="layui-input">
                    </div>
